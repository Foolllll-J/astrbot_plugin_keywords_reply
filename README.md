...
一款为 [**AstrBot**](https://github.com/AstrBotDevs/AstrBot) 设计的关键词回复插件，支持指令触发、自动监听、正则表达式、图文/At/QQ表情/语音/视频回复，以及引用消息导入内容与精细化的群聊黑白名单控制。
...
* **📝 多媒体回复**: 支持文字、图片、At、QQ表情的组合回复，并支持通过引用消息配置语音、视频内容
...
| 命令               | 格式                                   | 说明                                                    |
| :----------------- | :------------------------------------- | :------------------------------------------------------ |
| **添加**     | `/添加关键词 <关键词> <回复内容>`    | 添加新关键词，支持文本、图片、At、QQ表情；也可直接引用消息导入语音、视频等内容 |
...
| 命令               | 格式                                     | 说明                                                    |
| :----------------- | :--------------------------------------- | :------------------------------------------------------ |
| **添加**     | `/添加检测词 [-r] <关键词> <回复内容>` | `-r` 参数表示启用正则表达式匹配；回复内容支持文本、图片、At、QQ表情，也可直接引用消息导入语音、视频 |
...
> 添加或编辑回复时，`<新回复内容>` 可省略，可直接通过引用消息提供内容。引用导入仅 `aiocqhttp` 可用。
